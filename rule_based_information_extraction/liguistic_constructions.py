            ...
            for turn_i, turn_ in enumerate(dialog):
                ...
                for token in doc:
                    ...
                    for word2, nextWord2 in zip(syntax, syntax[1:]):
                            ...
                            if word_parse.tag.POS=="NOUN" :
                            ...
                            elif word_parse.tag.POS=="VERB" and word_parse.tag.person=="1per" and (word_parse2.tag.POS!="PREP" or word_parse2.tag.POS!="CONJ" or word_parse2.tag.POS=="ADVB"):
                                ngram.append(word_parse2.normal_form)
                            elif  word_parse.tag.POS=="VERB" and word_parse.tag.person=="1per" and (sintagma_next=="obj" or sintagma_next=="xcomp"):
                                ngram.append(word_parse2.normal_form)
                                ...
                                ngram.append(word_parse.normal_form)
                                ngram.append(word_parse2.normal_form)
                            elif (word_parse.tag.POS=="NPRO" and word_parse.tag.person=="1per") and word_parse2.tag.POS=="NOUN":
                                ngram.append(word_parse2.normal_form)
                    ...
                    for p in persona_:
                        ...
                        for token in doc_p:
                            ...
                            for word2, nextWord2 in zip(syntax, syntax[1:]):
                                ...
                                word_next = ''.join(word_next)
                                word_parse2= morph.parse(word_next)[0]    
                                if  (word_parse.tag.POS=="NOUN" and (sintagma=="ROOT" or sintagma=="nsubj" ) ): 
